...
if [ ! -f inputs/output.sed ]; then
    ...
    mv inputs/output.sed ${OUTPUTS10}
fi
if [ ! -f inputs/bmp-sedfil.out ]; then
    ...
    mv inputs/bmp-sedfil.out ${OUTPUTS11}
fi
if [ ! -f inputs/output.sub ]; then
    ...
    mv inputs/output.sub ${OUTPUTS12}
fi
